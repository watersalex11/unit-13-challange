...
def validate_data(first_name, age, investment_amount, risk_level,intent_request):#do i need intent_request, first_name and riskLevel?
    ...
    if investment_amount is not None:
        ...
        if investment_amount <=5000:
            return build_validation_result(
                False,
                "investmentAmount",
                "You need at least $5000 to use this service, "
                "please provide a new amount.",)

    return build_validation_result(True, None,None)
def invest(risk_level):
...
def recommend_portfolio(intent_request):
    ...
    #gets invocation source for lex dialogs "dialogcodehook"
    ...
    if source == "DialogCodeHook":
        ...
        ### YOUR DATA VALIDATION CODE STARTS HERE ###moved up
    ...
    initial_recommendation=invest(risk_level)        
